...
function Export() {
    ...
    return (
        <div className="w-full h-full flex bg-zinc-800 dark:bg-gray-900;">
            <div className="flex flex-col items-center justify-center justify-items-center w-1/3 border-r p-4 h-full">
                ...
                <div className="flex flex-col grow justify-between w-full">
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col">
                            ...
                            <select
                                ...
                                className="form-select block w-full mt-1 py-1 px-2 border-2 border-blue-400 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 outline-1 outline-gray-500"
                            >
                    ...
                    <div className="flex flex-col gap-4 items-center justify-items-start">
                        ...
                        >
                            <button
                                className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-l-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                onClick={handleExport}
                            >
                                Get Variables
                            </button>
                            <button
                                className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 border-l-0 rounded-r-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                onClick={() =>
                                    downloadJsonFile(
                                        fileContent,
            ...
            <div className="flex-1 p-4 overflow-y-auto overflow-x-auto items-center">
                <pre className="overflow-y-auto bg-gray-600 dark:bg-gray-700 overflow-x-auto grow">
                    {fileContent ? (
